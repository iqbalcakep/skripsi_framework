      ...
      <div class="card card-danger">
        <div class="card-block table-responsive">
            <table id="alexa_data" class="table table-hover">
               <thead> 
                <tr>
                  <th style="cursor:pointer" onclick="sorting('id','i_id')" class="text-center"  style="width: 50px">Id <i id="i_id" class="sortstatus fa fa-sort-down"></i></th>
...
@push('script')
    <script type='text/javascript' src='{{config('app.url')}}js/article.js'></script>
@endpush